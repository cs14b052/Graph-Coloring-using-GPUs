...
__global__ void firstFit(int* d_numVertices, const int* __restrict__ d_nonZeroIndices, const int* __restrict__ d_numColIndices, int* d_globalColoring, int* maxColor,long long int* adjColors){
...
__global__ void conflictResolve(const int* __restrict__ d_nonZeroIndices,const int* __restrict__ d_numColIndices, int* d_globalColoring,const int* __restrict__ d_nextVertexIndices, int* inlist, int* inNumV, int* outlist, int* globalIndex, int* maxColor,long long int* adjColors){
  int threadID = blockIdx.x * blockDim.x + threadIdx.x;
  int totalThreads = blockDim.x * gridDim.x;
